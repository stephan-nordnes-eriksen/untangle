...
Untangle = (function() {
  ...
  Untangle.request = function() {
    var argumentsCopy, type;
    type = arguments[0];
    argumentsCopy = [].shift.apply(arguments);
    if (_responders[type]) {
      return _responders[type].apply(this, arguments);
    }
    return null;
  };
  ...
  Untangle.helpers = function() {
    ...
    String.prototype.request = function() {
      [].unshift.call(arguments, this.toString());
      return Untangle.request.apply(this, arguments);
    };
